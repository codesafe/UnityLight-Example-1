...
Shader "Custom/FXAuraOutline" 
{
		...
		SubShader
		{
			...
			UsePass "Custom/ToonLit/FORWARD" // Base shader pass, using the standard ToonLit shader
			//UsePass "Custom/SurfaceToon/FORWARD" // Base shader pass, using the standard ToonLit shader
